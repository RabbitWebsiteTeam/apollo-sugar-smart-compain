<?php
set_include_path('/home/smartcliniq/public_html/PHPExcel/Classes/');
date_default_timezone_set("Asia/Kolkata");
$today=date("Y-m-d",strtotime("-1 days"));

require 'PHPExcel.php';
set_include_path('/home/smartcliniq/public_html/PHPMailer/');
require 'class.phpmailer.php';

include '/home/smartcliniq/public_html/Bin/PortalCSS.php'; 
include '/home/smartcliniq/public_html/Bin/PortalJS.php'; 
include '/home/smartcliniq/public_html/Config/Connection.php'; 

// Create your database query
$query = "SELECT * FROM memberdata WHERE updateddate='$today'";  
echo 'query'.$query;
...
echo "Before Creating Excel";
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('Q1', 'Time'); 
...
while($row = mysql_fetch_array($result)){ 
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('P'.$rowCount, $row['updateddate']); 
	$objPHPExcel->getActiveSheet()->SetCellValue('Q'.$rowCount, $row['updatedtime']); 
...
$email->Subject   = 'Apollo Sugars Campaign '.$today.' - Manual';
$email->IsHTML(true); 
...
$email->AddAddress( 'jatin.sahni@apollosugar.com' );
