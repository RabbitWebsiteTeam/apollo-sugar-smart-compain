...
<link rel="stylesheet" type="text/css" href="Bin/style.css" media="all">
<script async src="Bin/Js/jquery-2.1.4.min.js"></script>
...
<form name="myForm" novalidate ng-submit="myForm.$valid && login.submit()" id="memberrecord" action="SignIn.php" method="POST">		
	...
	<div class="col-sm-2 control-label">		
		<button type="submit"  name="submit" ng-disabled="myForm.$invalid" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-log-in"></span> Login</button> </div>
	</div>
